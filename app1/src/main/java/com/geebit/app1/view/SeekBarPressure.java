...
public class SeekBarPressure extends View {
    ...
    /** 滑动块顶部距离上边框距离，也就是距离字体顶部的距离 */
    private int mThumbMarginTop = 30;   
...
//        canvas.drawText((int) progressHigh + "", (int)mOffsetHigh - 2, 15, text_Paint);
        int startTime = (int) (progressLow/100 * NUM);
        int endTime = (int) (progressHigh/100 * NUM);
        canvas.drawText(secToTime(startTime), (int)mOffsetLow - 2 - 2, 15, text_Paint);
        canvas.drawText(secToTime(endTime), (int)mOffsetHigh - 2, 15, text_Paint);
...
//            Log.d("ACTION_UP", "------------------");
            ...
            //这两个for循环，是用来自动对齐刻度的，注释后，就可以自由滑动到任何位置
