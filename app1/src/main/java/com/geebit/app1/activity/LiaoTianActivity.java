...
public class LiaoTianActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!EMClient.getInstance().isLoggedInBefore()) {
            Intent intent = new Intent(LiaoTianActivity.this, LoginActivity.class);
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(chatId)) {
                    ...
                    if (chatId.equals(currUsername)) {
                        Toast.makeText(LiaoTianActivity.this, "不能和自己聊天", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    // 跳转到聊天界面，开始聊天
                    Intent intent = new Intent(LiaoTianActivity.this, ChatActivity.class);
                    intent.putExtra("ec_chat_id", chatId);
                    startActivity(intent);
                } else {
                    Toast.makeText(LiaoTianActivity.this, "Username 不能为空", Toast.LENGTH_LONG).show();
                }
            }
        });
